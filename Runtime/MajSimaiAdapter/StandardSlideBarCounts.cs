...
/// <summary>
/// Standard Majdata Slide prefab lengths. These are gameplay length units
/// used to divide connected-Slide time, not physical distance or note counts.
/// </summary>
internal static class StandardSlideBarCounts
{
        ...
        int endPosition)
    {
        ...
        return prefab switch
        {
            ...
            _ => throw new MajSimaiAdaptationException(
                $"No standard bar count for {startPosition}{shape}{viaPosition}{endPosition} ({prefab}).")
        };
    }
